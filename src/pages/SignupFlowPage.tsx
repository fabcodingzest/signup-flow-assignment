      ...
      <div className="flex min-h-screen items-start justify-center px-4 py-4 lg:items-center lg:px-0 lg:py-0">
        <div className="flex w-full max-w-[1240px] flex-col gap-4 lg:m-8 lg:h-[calc(100dvh-5rem)] lg:max-h-[800px] lg:flex-row lg:gap-x-6">
          ...
          <div className="flex w-full flex-col lg:h-full lg:w-1/2">
            ...
            <form
              className="mt-1 flex h-[calc(100dvh-15rem)] md:max-h-[700px] w-full max-w-[600px] flex-col self-center rounded-2xl bg-white px-5 py-6 shadow-panel sm:h-[calc(100dvh-14rem)] sm:px-6 sm:py-7 lg:min-h-[560px] lg:h-full lg:max-w-none lg:self-auto lg:px-16 lg:py-11 overflow-y-auto"
              onSubmit={(event) => {
