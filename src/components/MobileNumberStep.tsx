          ...
          <Controller
            ...
            render={({ field }) => (
              <input
                ...
                className={`min-w-0 flex-1 placeholder:text-text-muted rounded-xl border ${borderClass} ${hoverClass} ${focusClass} bg-white px-3 py-4 text-sm text-text-primary outline-none sm:py-5 sm:text-base lg:py-6.5`}
              />
            )}
          />
        </div>
